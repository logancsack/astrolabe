...
| `strict-json` | `glm47Flash -> glm5 -> gpt54Mini -> gpt54 -> sonnet` |
...
- Explicit structured output, schema-safe tool arguments, or repair flows promote the `strict-json` lane.
...
- `m27 -> glm47Flash -> glm5` for strict JSON / schema work
