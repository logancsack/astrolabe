...
| --- | --- |
| `auto` | `deepseekV4Pro -> m27 -> mimoV25Pro -> qwen36Plus -> kimiK26 -> sonnet` |
| `coding` | `deepseekV4Pro -> m27 -> mimoV25Pro -> kimiK26 -> glm51 -> sonnet` |
| `research` | `qwen36Plus -> mimoV25Pro -> m27 -> deepseekV4Pro -> grok420 -> gpt54 -> opus47 -> gpt55` |
| `vision` | `qwen36Plus -> kimiK26 -> gemma431b -> mistralSmall4 -> sonnet` |
