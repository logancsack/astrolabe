...
function createConfig(env = process.env) {
  return {
    ...
    ALLOW_PREVIEW_MODELS: envFlag(env, "ASTROLABE_ALLOW_PREVIEW_MODELS", false),
    STICKY_EXECUTOR_ENABLED: envFlag(env, "ASTROLABE_STICKY_EXECUTOR_ENABLED", true),
    SKIP_LOW_RISK_VERIFIER: envFlag(env, "ASTROLABE_SKIP_LOW_RISK_VERIFIER", true),
    SKIP_LOW_RISK_CLASSIFIER: envFlag(env, "ASTROLABE_SKIP_LOW_RISK_CLASSIFIER", true),
