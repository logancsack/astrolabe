...
const RAW_MODEL_MANIFEST = {
  ...
  grok420: createModelEntry("grok420", {
    ...
    multimodal: true,
    longContext: true,
    roleTags: ["deprecated", "raw_pin", "superseded_by_grok43"],
    laneTags: ["raw", "deprecated"],
    supportedParameters: [
      "include_reasoning",
      "logprobs",
  ...
  grok43: createModelEntry("grok43", {
    id: "x-ai/grok-4.3",
    short: "Grok 4.3",
    tier: "PREMIUM",
    inputCost: 1.25,
    ...
    multimodal: true,
    longContext: true,
    roleTags: ["agentic", "instruction_following", "premium_research", "long_context", "reasoning_always_on"],
    laneTags: ["auto", "coding", "research", "vision"],
    supportedParameters: [
      "frequency_penalty",
      "include_reasoning",
      "logprobs",
...
const LANE_MANIFEST = {
  auto: {
    ...
    defaultCandidates: ["deepseekV4Pro", "m27", "mimoV25Pro", "qwen36Plus", "kimiK26", "grok43", "sonnet"],
  ...
  coding: {
    ...
    defaultCandidates: ["deepseekV4Pro", "m27", "mimoV25Pro", "kimiK26", "glm51", "grok43", "sonnet"],
  ...
  research: {
    ...
    defaultCandidates: ["qwen36Plus", "mimoV25Pro", "m27", "deepseekV4Pro", "grok43", "gpt54", "opus47", "gpt55"],
  ...
  vision: {
    ...
    defaultCandidates: ["qwen36Plus", "kimiK26", "gemma431b", "mistralSmall4", "grok43", "sonnet"],
    fallbackCandidates: [],
...
const MODEL_FALLBACKS = {
  ...
  grok: ["gemma431b", "m27"],
  grok420: ["grok43", "qwen36Plus", "gpt54", "sonnet"],
  grok43: ["qwen36Plus", "gpt54", "sonnet"],
  ...
  qwen36Plus: ["mimoV25Pro", "grok43", "sonnet"],
